...
<template>
    <Head title="Wapatan" />
    <div class="bg-black bg-[url('/storage/bg.jpg')]">
        <div
                    ...
                    <div v-else class="text-center">
                        <div class="container mx-auto flex gap-4 overflow-x-auto p-4">
                            <div v-for="(wapatan, key) in currentWaps" :key="key"
                                class="flex flex-col gap-4 rounded-lg p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] bg-[#E6D0BE] ring ring-white ring-offset-2 shrink-0">
                                <h2 class="text-xl font-semibold text-black">
                                ...
                                <div class="flex flex-col gap-2 rounded-lg px-4 py-2 bg-[#FBFFAF] text-center"
                                    ...
                                    <div>
                                        ...
                                        <input type="number" :name="`${ing.name}-${key}`" min="0" v-model="wapatan.ingredients[ingKey].portions"
                                            class="text-black">
                                    </div>
                                </div>
                            </div>
                        ...
                        <button type="button"
                            ...
                            @click="makeOrder()">Realizar pedido</button>
                    </div>
                </main>
